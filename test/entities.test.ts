    ...
    describe(`decimals permutation: ${decimals}`, () => {
      ...
      describe('Trade', () => {
        ...
        it('TradeType.EXACT_INPUT', () => {
          ...
          expect(trade.executionPrice.toFixed(17)).toEqual('1.66249791562447891')
          expect(trade.executionPrice.invert().toFixed(18)).toEqual('0.601504513540621866')
          ...
          expect(trade.nextMidPrice.toFixed(17)).toEqual('1.38958368072925352')
          expect(trade.nextMidPrice.invert().toFixed(18)).toEqual('0.719640000000000000')

          expect(trade.slippage.toFixed(18)).toEqual('16.875104218776054700')
        })
        ...
        it('minimum TradeType.EXACT_INPUT', () => {
          if ([9, 18].includes(tokens[1].decimals)) {
            ...
            expect(trade.slippage.toFixed(18)).toEqual(
